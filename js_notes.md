...
✅ Because `userColor` is `null`, `??` also takes `"blue"`.

---

### 🔹 Example 3 — With a real value
...
Do you want me to also add this **with examples in Markdown format** so you can directly paste it into your notes file?
